    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Show product Details : <span class="text-danger">{{$product->name}}</span></h1>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        </section>
                        ...
                        <form action="{{route('products.update',[$product->id])}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" value="{{$product->name}}" class="form-control" readonly>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <center><img src="{{ asset('uploads/' . $product->image) }}"  width="60%" height="60%"></center>
